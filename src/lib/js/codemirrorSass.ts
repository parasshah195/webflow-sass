/**
 * File sources from @codemirror/lang-sass
 * @link https://github.com/codemirror/lang-sass/blob/main/src/sass.ts
 */
...
/// source.
export const sassCompletionSource = defineCSSCompletionSource(
